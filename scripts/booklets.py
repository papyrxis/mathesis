...
BOOKLET_SUBTITLE="From Mathesis --- an ongoing exploration of mathematical foundations"
...
PDF_KEYWORDS="keyword1, keyword2, keyword3, Mathesis"
...
BOOKLET_SUBTITLE="برگرفته از متسیس --- کاوشی جاری در بنیادهای ریاضیات"
