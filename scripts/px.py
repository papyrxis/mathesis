...
Modules:
    booklets (b)   Manage LaTeX booklets

Examples:
    python scripts/px.py
    python scripts/px.py booklets list
    python scripts/px.py b build 1
    python scripts/px.py b build 01-mathematical-logic-and-proof-theory:en
    python scripts/px.py b watch 01-mathematical-logic-and-proof-theory:en
    python scripts/px.py b new 15-new-topic
"""
...
def cmd_help() -> None:
    ...
    print()
    print(f"  {c('Examples:')}")
    print(f"    python scripts/px.py booklets list")
    print(f"    python scripts/px.py b build 1")
    print(f"    python scripts/px.py b watch 01-mathematical-logic-and-proof-theory:en")
    print(f"    python scripts/px.py b new 15-new-topic")
    print()
